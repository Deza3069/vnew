...
# Define file paths
CLEANMODE_DB = os.path.join(config.TEMP_FOLDER, "cleanmode.json")
COMMAND_DB = os.path.join(config.TEMP_FOLDER, "command.json")
...
AUDIO_FILE = os.path.join(config.TEMP_FOLDER, "audio.json")
VIDEO_FILE = os.path.join(config.TEMP_FOLDER, "video.json")
